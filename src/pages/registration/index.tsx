...
import { PlansData, AddOnsData } from '../../types'
...
export const RegistrationPage = () => {
  ...
  return (
    <div className="flex rounded-[24px] p-[20px] bg-white w-[fit-content] m-auto">
          ...
          {step === 2 && (
            <div className="flex flex-col justify-between h-[400px]">
              <div>
                ...
                <p className="text-sm text-slate-400 pb-5">
                  You have option of monthly or annual billing
                </p>
                <div className="flex justify-center">
                  {plansData.map((planData) => (
                    <CardPlan
                      ...
                      onClick={() => {
                        setPlan(() => planData)
                        formik.setFieldValue('plan', plan).catch((e) => {
                          throw e
                        })
          ...
          {step === 4 && (
            <div className="flex flex-col justify-between h-[400px]">
              <div>
                ...
                <p className="text-sm text-slate-400 pb-5">
                  Double Check if everything is OK before confirming
                </p>
                <Summary
                  addons={addons}
                  plan={plan}
